...
- Go 1.21 or later
- A Flagmint account and SDK API key (starts with `fm_sdk_`)

> **Management API coming soon.** Programmatic flag creation via API is not yet available. Create and manage flags in the [Flagmint dashboard](https://app.flagmint.com).
